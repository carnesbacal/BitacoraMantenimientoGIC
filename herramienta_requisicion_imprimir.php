...
/**
 * ============================================================================
 * herramienta_requisicion_imprimir.php - Vista imprimible / PDF de una requisición
 * ============================================================================
...
if (!hreq_disponible()) {
    die('Falta correr migracion_requisiciones_herramientas.sql.');
}
...
<div class="barra">
    <a href="<?= url('herramienta_requisicion_ver.php?id=' . $id) ?>">← Volver</a>
    <button onclick="window.print()">Imprimir</button>
    <button class="primario" onclick="descargarPDF()">Descargar PDF</button>
    <a href="<?= url('herramienta_requisicion_imprimir.php?id=' . $id . '&formato=controlado&empresa=' . urlencode($emp_clave)) ?>"
       style="<?= $formato === 'controlado' ? 'background:#f4f4f5;font-weight:700' : '' ?>">Formato 0069-FRM</a>
    <a href="<?= url('herramienta_requisicion_imprimir.php?id=' . $id . '&formato=simple&empresa=' . urlencode($emp_clave)) ?>"
    ...
    <a href="<?= url('herramienta_requisicion_imprimir.php?id=' . $id . '&formato=' . $formato . '&empresa=' . urlencode($k)) ?>"
